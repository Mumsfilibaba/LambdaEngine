...
namespace LambdaEngine
{
	...
	public:
		...
		*	return		- a valid GUID if the sound was loaded, otherwise returns GUID_NONE
		*/
		static GUID_Lambda LoadMusicFromFile(const char* pFilepath);
	...
	private:
		...
		static THashTable<GUID_Lambda, Mesh*>			s_Meshes;
		static THashTable<GUID_Lambda, Material*>		s_Materials;
		static THashTable<GUID_Lambda, ITexture*>		s_Textures;
		static THashTable<GUID_Lambda, ITextureView*>	s_TextureViews;
		static THashTable<GUID_Lambda, IShader*>		s_Shaders;
		static THashTable<GUID_Lambda, IMusic*>			s_Music;
		static THashTable<GUID_Lambda, ISoundEffect3D*>	s_SoundEffects;

		static THashTable<GUID_Lambda, ShaderLoadDesc>		s_ShaderLoadConfigurations;
	};
}
